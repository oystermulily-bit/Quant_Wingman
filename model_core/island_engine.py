...
同时维护 N 个独立的 W1ngmanEngine（island），每个 island 独立探索不同的
...
from .engine import W1ngmanEngine


class IslandW1ngmanEngine:
    """管理多个 W1ngmanEngine 组成 island population。"""
    ...
    def __init__(self, data_manager, n_islands: int | None = None,
        ...
        self.islands: list[W1ngmanEngine] = []
        for i in range(self.n_islands):
            isl = W1ngmanEngine(data_manager=data_manager)
    ...
    def train(self):
        ...
        print(f"\n{'='*60}")
        print(f"  Island W1ngman Training")
