...
class ModelConfig:
    ...
    RD_AGENT_FORMULA_TIMEOUT_SECONDS: float = 8.0
    RD_AGENT_ROUND_TIMEOUT_SECONDS: float = 180.0
    RD_AGENT_API_TIMEOUT_SECONDS: float = 90.0
    ...
    HOLDOUT_PROTOCOL: str = "chronological_holdout_10_v1"
