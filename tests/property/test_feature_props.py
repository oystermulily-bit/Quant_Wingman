# Feature: mt5-w1ngman-refactor, Property 3: 特征张量形状不变量
# Feature: mt5-w1ngman-refactor, Property 4: 特征值有界性
"""
...
def test_property3_feature_tensor_shape(n: int, t: int):
    ...
    must return a tensor of shape exactly [N, INPUT_DIM, T].
    ...
    expected_dim = MT5FeatureEngineer.INPUT_DIM
    assert features.shape == (n, expected_dim, t), (
        f"Expected shape ({n}, {expected_dim}, {t}), got {tuple(features.shape)}"
    )
